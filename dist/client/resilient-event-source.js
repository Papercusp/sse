...
exports.DESKTOP_IPC_STREAM_IDLE_TIMEOUT_MS = exports.DEFAULT_ZOMBIE_TIMEOUT_MS = void 0;
exports.createResilientEventSource = createResilientEventSource;
 ...
 */
exports.DEFAULT_ZOMBIE_TIMEOUT_MS = 45_000;
/**
 ...
 */
exports.DESKTOP_IPC_STREAM_IDLE_TIMEOUT_MS = 32_000;
const DEFAULTS = {
    initialBackoffMs: 1_000,
    maxBackoffMs: 30_000,
    jitter: 0.2,
    zombieTimeoutMs: exports.DEFAULT_ZOMBIE_TIMEOUT_MS,
    maxConsecutiveFailures: 3,
    visibilityPauseMs: 60_000,
};
function createResilientEventSource(opts) {
    ...
    const connect = () => {
        ...
        releaseSlot?.();
        releaseSlot = (0, stream_registry_1.registerLiveStream)(url);
        ...
        es.addEventListener('error', () => {
            ...
            if (cfg.maxConsecutiveFailures > 0
                ...
                && !escalated) {
                escalated = true;
                opts.onError?.(new Error(`SSE connection to ${url} failed ${consecutiveFailures} consecutive times`));
            }
